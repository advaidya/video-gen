"""Orchestrator entry point for the prompt-service agent harness."""

import asyncio
import os
import sys

# Allow running directly: python3 prompt-service/agent_harness/main.py
...
SERVICE_NAME = "Prompt Generation Service"
...
async def main() -> None:
    ...
    # Project dir is the prompt-service/ directory (parent of agent_harness/)
